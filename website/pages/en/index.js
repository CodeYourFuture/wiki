    ...
    return (
      <SplashContainer>
        <div className="inner">
          ...
          <PromoSection>
            <Button href="https://syllabus.codeyourfuture.io">Syllabus</Button>
          ...
          <PromoSection>
            ...
            <Button href={docUrl("cities/rome/home")}>Rome</Button>
            <Button href={docUrl("cities/capetown/home")}>Cape Town</Button>
          </PromoSection>
        </div>
      </SplashContainer>
    );
